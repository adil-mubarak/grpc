...
const (
	GreetingService_GetGreeting_FullMethodName = "/greeting.GreetingService/GetGreeting"
)
...
func (c *greetingServiceClient) GetGreeting(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingResponse, error) {
...
func (UnimplementedGreetingServiceServer) GetGreeting(context.Context, *GreetingRequest) (*GreetingResponse, error) {
...
func _GreetingService_GetGreeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServiceServer).GetGreeting(ctx, req.(*GreetingRequest))
	}
